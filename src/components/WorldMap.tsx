...
const destinations = [
    { name: "New York", code: "US", coords: [40.7128, -74.0060] },
    { name: "London", code: "UK", coords: [51.5074, -0.1278] },
    { name: "Berlin", code: "DE", coords: [52.5200, 13.4050] },
...
const customIcon = L.divIcon({
    ...
    html: `<div class="w-4 h-4 bg-[#FF6B35] rounded-full border-2 border-white shadow-lg"></div>`,
    iconSize: [16, 16],
    iconAnchor: [8, 8],
});
