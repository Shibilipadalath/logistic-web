...
const features = [
    {
        ...
        description: "We prioritize speed and safety, making sure your goods arrive on time and in perfect condition.",
        icon: (
    ...
    },
    {
        ...
        description: "Every business is different. We tailor logistics strategies that fit your timeline, budget, and requirements.",
        icon: (
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    },
    {
        ...
        description: "Stay informed with real-time shipment tracking and dedicated customer support whenever you need it.",
        icon: (
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export default function WhyChooseUs() {
    return (
        <section className="relative py-24 mx-auto max-w-[1400px] px-4 md:px-6">
            <div className="relative rounded-[3rem] overflow-hidden min-h-[600px] bg-slate-900">
                ...
                <div className="relative z-10 p-8 md:p-16 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center h-full">
                    ...
                    <div className="space-y-8 h-full flex flex-col justify-between">
                        <div>
                            <span className="text-sm font-bold tracking-widest text-white/80 uppercase block mb-4">
                                {"// Why Choose Us //"}
                            </span>
