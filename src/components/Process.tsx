...
const steps = [
    {
        number: "01",
        title: "Sourcing",
        description: "We locate and procure the highest quality goods from our trusted global network of suppliers.",
        icon: (
    ...
    },
    {
        number: "02",
        title: "Packaging",
        description: "Expert handling and secure packaging ensure your items remain safe throughout their journey.",
        icon: (
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    },
    {
        number: "03",
        title: "Shipping",
        description: "Fast and reliable global shipping with real-time tracking updates until final delivery.",
        icon: (
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
                    ...
                    <p className="text-gray-400 max-w-sm text-lg">
                        From source to destination, we handle every detail with precision and care.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
                    ...
                    {steps.map((step, index) => (
                        <div key={index} className="relative z-10 group">
                            ...
                            {/* Number */}
                            <span className="text-6xl font-bold text-gray-800 absolute top-4 right-4 opacity-50 select-none group-hover:text-gray-700 transition-colors">
                                {step.number}
                            </span>
