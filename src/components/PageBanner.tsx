  ...
  return (
    <section className="relative w-full h-[50vh] min-h-[400px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto flex flex-col items-center gap-6 animate-fade-in-up">
        {subtitle && (
          <span className="px-4 py-1 rounded-full border border-[#c1b588]/40 bg-black/30 backdrop-blur-sm text-[#c1b588] font-bold tracking-[0.2em] uppercase text-xs md:text-sm shadow-sm">
            {subtitle}
          </span>
        )}
        ...
        <div className="w-32 h-1.5 bg-gradient-to-r from-transparent via-[#c1b588] to-transparent rounded-full opacity-90" />
      </div>
    </section>
  );
}
