...
export default function Footer() {
    return (
        <footer className="bg-black text-white pt-24 pb-12 overflow-hidden relative rounded-t-[3rem] mt-[-3rem]">
                    ...
                    <div className="lg:col-span-4">
                        ...
                        <div className="flex gap-4">
                            {[
                                ...
                                <a key={idx} href="#" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-orange-500 transition-colors text-white">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <ul className="space-y-4">
                            {['Home', 'About Us', 'Service', 'Gallery', 'Contact'].map((item) => (
                                <li key={item}>
                                    <a href="#" className="text-gray-400 hover:text-orange-500 transition-colors">{item}</a>
                                </li>
                            ))}
                        </ul>
                    </div>
                    ...
                    <div className="lg:col-span-4">
                        ...
                        <div className="relative mb-8">
                            <input
                                ...
                                className="w-full bg-white/5 border border-white/10 rounded-full px-6 py-3 text-sm focus:outline-none focus:border-orange-500 transition-colors text-white placeholder:text-gray-500"
                            />
                            <button className="absolute right-1 top-1 bottom-1 bg-orange-500 hover:bg-orange-600 px-6 rounded-full text-sm font-bold transition-colors">
                                Subscribe
                            </button>
                        </div>
