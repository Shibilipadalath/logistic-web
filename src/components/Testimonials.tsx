                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
                    ...
                    <div className="lg:col-span-4 flex flex-col justify-between">
                        <div className="max-w-xs">
                            <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wide leading-relaxed mb-8">
                                Words from the<br />ones who know us<br />best
                            </h3>
                        </div>

                        <div className="mt-auto">
                            <div className="flex items-baseline text-gray-900">
                                <span className="text-5xl md:text-7xl font-light tracking-tighter mr-1">+</span>
                                <span className="text-6xl md:text-8xl font-bold tracking-tighter">99</span>
                                <span className="text-5xl md:text-7xl font-light tracking-tighter text-gray-400">%</span>
                            </div>
                    ...
                    <div className="lg:col-span-8 flex flex-col justify-center">
                        ...
                        <div className="flex items-center justify-between border-t border-gray-100 pt-8">
                            <div className="flex items-center gap-4">
                                ...
                                {/* Info */}
                                <div>
                                    <h4 className="text-xl font-bold text-gray-900">David Wilson</h4>
                                    <p className="text-gray-500">Business Consultant</p>
                                </div>
                            </div>

                            {/* Social Icon */}
                            <a href="#" className="w-10 h-10 rounded-lg bg-gray-50 flex items-center justify-center hover:bg-gray-100 transition-colors text-gray-900">
                                {/* X / Twitter Icon */}
