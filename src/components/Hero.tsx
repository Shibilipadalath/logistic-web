  ...
  return (
    <section className="relative pt-36 pb-20 px-4 md:px-8 max-w-[1400px] mx-auto flex flex-col items-center text-center">
      ...
      <div className="flex items-center gap-5 mb-16 relative z-20">
        ...
        <button className="bg-white border text-gray-700 hover:text-black shadow-gray-200 border-gray-200 hover:border-gray-300 px-9 py-4 rounded-full text-base font-bold transition-all hover:bg-gray-50 cursor-pointer">
          Contact Us
        </button>
      </div>
